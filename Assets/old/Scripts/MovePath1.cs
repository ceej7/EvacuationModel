...
[System.Serializable]
public class MovePath1 : MovePathGeneral
{
    [SerializeField]
    ...
    public void MyStart(int _w, int _i, string anim, bool _loop, bool _forward, bool gender)
    {
        ...
        walkPath = GameObject.Find("Run1");
        var _WalkPath = walkPath.GetComponent<WalkPath1>();
    ...
    void Start()
    {
        GetComponent<Animator>().CrossFade(animName, fadeInterval, 0, Random.Range(0.0f, 1.0f));
        fire = false;
