...
public class WorldGenerator : MonoBehaviour 
{
	...
	public float		globalTemperature = 38.0f;
		...
		for (int y = 0; y < sizeY; ++y) 
		{
			...
			for (int x = 0; x < sizeX; ++x) 
			{
                ...
                if (a % 2==1)
                    ...
                    go = Instantiate(cellPrefab2);

                cell = go.GetComponent<Cell>();
                cell._currentWorldGenerator = this;
				...
				cell.SetMaterial(selectedMaterials[rand.Next(0, selectedCount)]);
				cell.SetValues(rand);
